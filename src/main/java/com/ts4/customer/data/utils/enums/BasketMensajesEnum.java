...
@Getter
public enum BasketMensajesEnum {
	
	INVALID_CUSTOMER("InvalidCustomerException","Usuario proporcionado incorrecto "),
	INVALID_ORDER_STATUS("InvalidOrderStatusException","Estatus de la orden incorrecto"),
	...
	BasketMensajesEnum( String messageSf,String messageCustom) {
	        this.messageSf = messageSf;
	        this.messageCustom = messageCustom;

	}	
	
	public static BasketMensajesEnum getMessageValueOf(String messageSf) {
		for(BasketMensajesEnum enumInd:BasketMensajesEnum.values()) {
